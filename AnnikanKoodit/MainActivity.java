...
/*
* Pelin aloitusvalikko, jossa valitaan itselle nimi ja etsitään laiteparit.
*
* TODO: Muokkaa sopivat aktiviteetit vanhojen tilalle! Esim BT_TTT tilalle korvaavan tiedoston nimi. Rivi 341.
* HOX! Omaan manifest tiedostoon tarvittavat muutokset (lisää aktivity)!
*
*/
public class MainActivity extends AppCompatActivity {
    ...
    final private int REQUEST_CODE_ASK_ACCESS_FINE_LOCATION = 124;
    ...
    private void checkPerm(){
        ...
        if (!hasPermission) {
            ActivityCompat.requestPermissions(this,
                    ...
                    REQUEST_CODE_ASK_ACCESS_FINE_LOCATION);
            return;
        }
        testBT();
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults) {
        ...
        switch (requestCode)
        {
            case REQUEST_CODE_ASK_ACCESS_FINE_LOCATION: {
    ...
    protected void testBT() {
        ...
        if(mBluetoothAdapter == null) {
            ...
            selectedDeviceText = findViewById(R.id.textViewSelectedDev);
            ...
            myListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                    ...
                    selectedDeviceText.setText("Selected device: " + selectedDevice);
                }
            });
    ...
    public void find(View view) {
        if (mBluetoothAdapter.isDiscovering()) {
            ...
            BTArrayAdapter.add("Discovery Started" + "\n" + " ");
            BTArrayAdapter.notifyDataSetChanged();
        }
    }
...
//        Toast.makeText(getApplicationContext(),"Game is starting, " + MyName,
//                Toast.LENGTH_LONG).show();

        Intent intent = new Intent(MainActivity.this, BT_TTT.class);
